...
\begin{proof}[Proof of \autoref{eq:quicksort-swaps-two}]
  ...
  justified in \url{http://nbviewer.ipython.org/github/massimo-nocentini/pacc/blob/master/sympy-notebook/Analysis\%20of\%20Algorithms.ipynb?flush_cache=true\#Checks-for-Equation-1.2}}:
  \begin{displaymath}
    \begin{split}
...
in the companion IPython Notebook \footnote{see
    \url{http://nbviewer.ipython.org/github/massimo-nocentini/pacc/blob/master/sympy-notebook/Analysis\%20of\%20Algorithms.ipynb?flush_cache=true\#Quicksort:-average-number-of-swap}}.
